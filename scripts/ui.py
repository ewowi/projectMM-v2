...
SCRIPTS = [
    ...
    {"id": "flashfs-esp32dev",  "group": "ESP32",        "label": "Flash filesystem (esp32dev)",      "scripts": ["flash.py"], "args": ["esp32dev",      "--target", "uploadfs"], "needs_port": True},
    {"id": "flashfs-esp32s3",   "group": "ESP32",        "label": "Flash filesystem (esp32s3_n16r8)", "scripts": ["flash.py"], "args": ["esp32s3_n16r8", "--target", "uploadfs"], "needs_port": True},
